...
$of_options_buler_pmc[] = array( "name" => "Share this product title",
                    ...
                    "std" =>  __('<span>Share</span> this product','wp-camy'),
                    "type" => "text");	
...
$of_options_buler_pmc[] = array( "name" => "Our Futured Products",
                    ...
                    "std" => __('Our Futured Products','wp-camy'),
                    "type" => "text");	
...
$of_options_buler_pmc[] = array( "name" => "Big quote text ",
					...
					"id" => "quote_big",
					"std" => __('CHECK OUR LATEST WORDPRESS THEME THAT IMPLEMENTS PAGE BUILDER','wp-buler'),
					"type" => "text"); 	

$of_options_buler_pmc[] = array( "name" => "Small quote text ",
					"desc" => "Enter small text for quote bar.",
					"id" => "quote_small",
					"std" => __('- learn how to build Wordpress Themes with ease with a premium Page Builder which allows you to add new Pages in seconds.','wp-buler'),
					"type" => "text"); 	
...
$of_options_buler_pmc[] = array( "name" => "Telephone text",
					...
					"std" => __('Premiumcoding Telephone','wp-buler'),
					"type" => "text"); 			
...
$of_options_buler_pmc[] = array( "name" => "Mail text",
					...
					"std" => __('Premiumcoding Mail','wp-buler'),
					"type" => "text"); 
...
$of_options_buler_pmc[] = array( "name" => "404 Error page Title Content Text",
                    ...
                    "id" => "errorpage",
                    "std" => __('Sorry, but the page you are looking for has not been found.<br/>Try checking the URL for errors, then hit refresh.</br>Or you can simply click the icon below and go home:)','wp-buler'),
                    "type" => "textarea");	   	
...
$of_options_buler_pmc[] = array( "name" => "Copyright info",
                    ...
                    "id" => "copyright",
                    "std" => __('&copy; 2011 All rights reserved. ','wp-buler'),
                    "type" => "textarea");	
...
$of_options_buler_pmc[] = array( "name" => "Home page Our major brands",
                    ...
                    "std" => __('Our major brands','wp-buler'),
                    "type" => "text");	
...
$of_options_buler_pmc[] = array( "name" => "Read more for blog",
                    ...
                    "std" => __('Read more about this...','wp-buler'),
                    "type" => "text");						
...
$of_options_buler_pmc[] = array( "name" => "Leave the comment",
                    ...
                    "std" => __('Leave the comment ','wp-buler'),
                    "type" => "text");
...
$of_options_buler_pmc[] = array( "name" => "Share post",
                    ...
                    "std" => __('Share this post','wp-buler'),
                    "type" => "text");		
...
$of_options_buler_pmc[] = array( "name" => "Recent Comments text",
                    ...
                    "std" => __('Recent Comments','wp-buler'),
                    "type" => "text");						
...
$of_options_buler_pmc[] = array( "name" => "Leave a Reply to text",
                    ...
                    "std" => __('Leave a Reply to','wp-buler'),
                    "type" => "text");		
...
$of_options_buler_pmc[] = array( "name" => "Comments are closed text",
                    ...
                    "std" => __('Comments are closed.','wp-buler'),
                    "type" => "text");		
...
$of_options_buler_pmc[] = array( "name" => "Transfer Theme Options Data",
                    "id" => "of_transfer",
