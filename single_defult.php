	...
	<div class="content singledefult">
		...
		if ($query_custom->have_posts()) : ?>
			...
			<div class="relatedtitle">
				<h3><?php if (!function_exists('icl_object_id') or (ICL_LANGUAGE_CODE == $sitepress->get_default_language()) ) { echo pmc_stripText($pmc_data['translation_relatedpost']); } else {  _e('Related post','wp-buler'); } ?></h3>
			</div>
			<div class="related">	
