...
class recent_posts extends WP_Widget {
	function recent_posts() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'recent_posts', 'description' => 'Displays the post image and title.'.'wp-buler' );



		/* Create the widget. */
		$this->WP_Widget( 'recent_posts-widget', __('Buler - Premium Recent Posts', 'wp-buler'), $widget_ops, '' );
	}
