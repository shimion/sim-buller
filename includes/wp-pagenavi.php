...
function pagenavi_init() {
	...
	$pagenavi_options = array(
		'pages_text' => __('Page %CURRENT_PAGE% of %TOTAL_PAGES%','wp-buler'),
		'current_text' => '%PAGE_NUMBER%',
		'page_text' => '%PAGE_NUMBER%',
		'first_text' => __('&laquo; First','wp-buler'),
		'last_text' => __('Last &raquo;','wp-buler'),
		'next_text' => __('&raquo;','wp-buler'),
		'prev_text' => __('&laquo;','wp-buler'),
		'dotright_text' => __('...','wp-buler'),
		'dotleft_text' => __('...','wp-buler'),
		'style' => 1,
		'num_pages' => 5,
		'always_show' => 0,
