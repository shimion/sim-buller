...
<div class="homerecent SP">
	...
	<h3 class="titleborderh">
		<?php if (!function_exists('icl_object_id') or (ICL_LANGUAGE_CODE == $sitepress->get_default_language()) ) { echo pmc_stripText($pmc_data['translation_also_like']); } else {  _e('<span>Also</span> like','wp-adamas'); } ?>
	</h3>
	<div id="homerecent">
