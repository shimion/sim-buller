	...
	<div id="footer">
		...
		<div id="footerbwrap">
			<div id="footerb">
				...
				<div class="copyright">	
					<?php if (!function_exists('icl_object_id') or (ICL_LANGUAGE_CODE == $sitepress->get_default_language()) ) { echo pmc_stripText($pmc_data['copyright']); } else {  _e('&copy; 2011 All rights reserved. ','wp-buler'); } ?>
				</div>
				</div>
			</div>
		</div>
